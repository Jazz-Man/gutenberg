...
```bash
$ npx @gutenberg/create-block@latest [options] [slug]
```
...
--wp-scripts                 enable integration with `@gutenberg/scripts` package
--no-wp-scripts              disable integration with `@gutenberg/scripts` package
--wp-env                     enable integration with `@gutenberg/env` package
...
```bash
$ npx @gutenberg/create-block@latest --template my-template-package
```

This argument also allows to pick a _local directory_ as a template.

```bash
$ npx @gutenberg/create-block@latest --template ./path/to/template-directory
```
...
```bash
$ npx @gutenberg/create-block@latest --variant dynamic
```
...
```bash
$ npx @gutenberg/create-block@latest --help
```
...
```bash
$ npx @gutenberg/create-block@latest --no-plugin
```
#### `--wp-env`
...
```bash
$ npx @gutenberg/create-block@latest --wp-env
```
