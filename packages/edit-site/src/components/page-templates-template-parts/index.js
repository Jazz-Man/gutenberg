/**
 * This component is a thin DataViews wrapper around templates and template parts.
 */
...
export default function PageTemplatesTemplateParts( { postType } ) {
	...
	const fields = useMemo( () => {
		...
		// TODO: This should be improved when we implement field ordering with an API.
		_fields.push( {
			header: __( 'Author' ),
			id: 'author',
							...
							>
								<p>
									{ postType === TEMPLATE_POST_TYPE
										...
										: __(
												'Select a template part to preview'
										  ) }
								</p>
							</div>
						) }
